...
| <a name="input_cloudwatch_logs_role_name"></a> [cloudwatch\_logs\_role\_name](#input\_cloudwatch\_logs\_role\_name) | Name for the IAM role used by the CloudWatch Logs integration. If null, Terraform generates a name using cloudwatch\_logs\_name as a prefix. | `string` | `null` | no |
...
| <a name="input_cloudwatch_metrics_role_name"></a> [cloudwatch\_metrics\_role\_name](#input\_cloudwatch\_metrics\_role\_name) | Name for the IAM role used by the CloudWatch Metrics integration. If null, Terraform generates a name using cloudwatch\_metrics\_name as a prefix. | `string` | `null` | no |
...
| <a name="input_rds_logs_cloudwatch_role_name"></a> [rds\_logs\_cloudwatch\_role\_name](#input\_rds\_logs\_cloudwatch\_role\_name) | Name for the IAM role used by CloudWatch Logs in the RDS Logs integration. If null, Terraform generates a name using rds\_logs\_name as a prefix. | `string` | `null` | no |
| <a name="input_rds_logs_cloudwatch_role_permissions_boundary"></a> [rds\_logs\_cloudwatch\_role\_permissions\_boundary](#input\_rds\_logs\_cloudwatch\_role\_permissions\_boundary) | ARN of the permissions boundary policy to attach to the RDS Logs integration's CloudWatch Logs IAM role. | `string` | `null` | no |
| <a name="input_rds_logs_firehose_role_name"></a> [rds\_logs\_firehose\_role\_name](#input\_rds\_logs\_firehose\_role\_name) | Name for the IAM role used by the RDS Logs integration's Kinesis Data Firehose. If null, Terraform generates a name using rds\_logs\_name as a prefix. | `string` | `null` | no |
...
| <a name="input_rds_logs_lambda_role_name"></a> [rds\_logs\_lambda\_role\_name](#input\_rds\_logs\_lambda\_role\_name) | Name for the IAM role used by the RDS log transform Lambda function. If null, the Lambda function name is used. | `string` | `null` | no |
...
| <a name="input_s3_logfile_lambda_role_name"></a> [s3\_logfile\_lambda\_role\_name](#input\_s3\_logfile\_lambda\_role\_name) | Name for the IAM role used by the S3 log processor Lambda function. If null, the Lambda function name is used. | `string` | `null` | no |
